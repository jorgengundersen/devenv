...
- You are running in an devenv container. Any tool available in devenv, you have access to.
...
- Do GAP analysis as part of research when asked to create a research document.
- Use checkmarks when creating plans
